			...
			<div class="block-border">
				<?php echo $this->element('backend/server_error');
					...
					<fieldset>
						...
						<p>
							<label for="simple-required">Delimiter<?php echo REQUIRED; ?></label> 
							<?php echo $this->Form->input('delimiter',array('class'=>'full-width','id'=>"d_s_delimiter","maxlength"=>"1"));?>
						</p>
						<p>
							<label for="simple-required">Description[({VENDOR_NAME}, {VOUCHER}, {COUPON_CODE}, {ACTIVATION_CODE}, {USERNAME}, {ADDRESS}, {CITY}, {POSTNUMBER}, {DATE}, {TIME})<?php echo REQUIRED; ?>]<?php echo REQUIRED; ?></label> 
							<?php
						...
						<p>
							<label for="simple-required">Sms Description[({VENDOR_NAME}, {VOUCHER}, {COUPON_CODE}, {ACTIVATION_CODE}, {USERNAME}, {ADDRESS}, {CITY}, {POSTNUMBER}, {DATE}, {TIME})<?php echo REQUIRED; ?>]<?php echo REQUIRED; ?></label> 
							<?php
