				...
				<div class="block-border">
						...
						<fieldset>
								...
								<p>
										...
										echo $this->Form->input('selling_limit',array('type'=>'select','legend'=>false,'options'=>$salling_options,'class'=>'full-width',"empty"=>"Select selling limit"));
										?>
								</p>
								
								<p>
										<label for="simple-required">Selling Price Limit(DKK)<?php echo REQUIRED; ?></label> 
										<?php echo $this->Form->input('selling_price_limit',array('type'=>'text','class'=>'full-width'));?>
								</p>
								
								<p>
										<label for="simple-required">ID<?php echo REQUIRED; ?></label> 
										<?php echo $this->Form->input('u_id',array('type'=>'text','class'=>'full-width'));?>
								</p>
								...
								<p>
										...
										<?php echo $this->Form->input('powd',array('type'=>'password','class'=>'full-width'));?>
								</p>
								<p>
