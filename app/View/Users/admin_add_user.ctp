		...
		<section class="grid_12">
				<div class="block-border">
						...
						<fieldset>
								...
								<p>
										<label for="simple-required">Username<?php echo REQUIRED; ?></label> 
										<?php echo $this->Form->input('u_name',array('type'=>'text','class'=>'full-width'));?>
								</p>
								...
								<p>
										<label for="simple-required">address<?php echo REQUIRED; ?></label> 
										<?php echo $this->Form->input('UserProfile.address',array('class'=>'full-width'));?>
								</p>
								<p>
										<label for="simple-required">City<?php echo REQUIRED; ?></label> 
										<?php echo $this->Form->input('UserProfile.city',array('class'=>'full-width'));?>
								</p>
								<p>
										<label for="simple-required">Post Number<?php echo REQUIRED; ?></label> 
										<?php echo $this->Form->input('UserProfile.post_number',array('class'=>'full-width'));?>
								</p>
								<p>
