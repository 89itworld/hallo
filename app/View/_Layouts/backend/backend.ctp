		...
		<ul id="status-infos">
			...
			<li>
				<a href="#" class="button" title="5 messages"><img src="images/icons/fugue/mail.png" width="16" height="16"> <strong>5</strong></a>
						...
						<li>
							<?php echo $this->Html->link('<span class="smaller">LOGOUT</span>',array("controller"=>"users","action"=>"logout","admin"=>true),array("escape"=>false,"class"=>"button red","title"=>"Logout"));?>	
						</li>
		</ul>
