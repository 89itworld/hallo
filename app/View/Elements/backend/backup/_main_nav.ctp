...
<nav id="main-nav">
		<ul class="container_12">
				<?php
				$main_tab = array("1"=>"home","2"=>"users","3"=>"comments","4"=>"medias","6"=>"settings","7"=>"write","8"=>"write","46"=>"stats","62"=>"backup","73"=>"pull");
				$main_tab_title = array("1"=>"Dashboard","2"=>"User Management","3"=>"Role Management","4"=>"Vendor Management","6"=>"Product Management","7"=>"Coupon Management","8"=>"Sale Coupon Management","46"=>"Report Management","62"=>"Settings","73"=>"Pull Coupons");
