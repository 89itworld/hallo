...
$(document).ready(function(){
	     ...
	     advancegraph(null,7);
	     $("#ovfer div:first").html('<div style="margin:auto;"><img src="'+ajax_url+'img/loader_graph.gif" class="temp_loading" alt="Please wait..." style="margin:auto;display:block;"></div>');
	     $("#gen").click(function (){
