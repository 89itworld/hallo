	...
	<article class="container_12">
		...
		<section class="grid_8">
			...
			<div class="block-border">
				...
				<?php echo $this->Form->create("Coupon",array('url'=>array('controller'=>'coupons','action' => 'edit', 'admin' =>true),'inputDefaults'=>array('div'=>false,'label'=>false),'id'=>'add_record', 'name' => 'add_record','class' => 'block-content form'));
				...
				?>
					...
					<fieldset>							 
						...
						<p>
							...
							echo $this->Form->input('category_id',array('type'=>'select','legend'=>false,'label'=>FALSE,'options'=>$category_list,'empty'=>"Select category",'class'=>'full-width','id'=>'select_category','selected'=>$category_selected)); ?>	
						</p>
						<p>
							<label for="simple-required">Product<?php echo REQUIRED; ?></label> 
							<?php
							$product_selected = ((isset($this->data['Coupon']['product_id']) && ($this->data['Coupon']['product_id'] != "")))?$this->data['Coupon']['product_id']:"";
							echo $this->Form->input('product_id',array('type'=>'select','legend'=>false,'label'=>FALSE,'empty'=>"Select product",'options'=>$product_options,'class'=>'full-width','id'=>'select_product_list','selected'=>$product_selected)); ?>	
						</p> 
