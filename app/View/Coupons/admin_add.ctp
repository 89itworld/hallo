				...
				<?php echo $this->Form->create('Coupon',array('url'=>array('controller'=>'coupons','action' => 'add', 'admin' =>true),'inputDefaults'=>array('div'=>false,'label'=>false),'id'=>'add_record', 'name' => 'add_record','class' => 'block-content form')); ?>
					...
					<fieldset>							 
						...
						<p>
							...
							<?php echo $this->Form->input('category_id',array('type'=>'select','legend'=>false,'label'=>FALSE,'options'=>$category_list,'empty'=>"Select voucher",'class'=>'full-width','id'=>'select_category')); ?>	
						</p>
						<p>
							<label for="simple-required">Product Code<?php echo REQUIRED; ?></label> 
							<?php echo $this->Form->input('product_code',array('type'=>'select','legend'=>false,'label'=>FALSE,'empty'=>"Select product code",'class'=>'full-width','id'=>'select_product_list')); ?>	
						</p>
						<p>
