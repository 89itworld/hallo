<div class="">
    <div class="lite-grey-gradient with-padding">
        ...
        <div class="col200pxL-right">
            <div style="min-height: 302px;" class="tabs-content" id="tab-global">
                    ...
                    <table width="100%" cellspacing="0" class="table">
                        ...
                        <tbody>
                                ...
                                <tr>                                
                                    ...
                                    echo str_replace("_"," ",substr($csv_file,0,strrpos($csv_file, '_', -26)));
                                    ?>
                                    </td>
                                    <td>
            ...
            <div class="tabs-content" id="tab-settings" style="min-height: 302px; display: none;">
                <div style="margin-bottom: 5px;">
                    <?php
                    ...
                    <table width="100%" cellspacing="0" class="table">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    echo str_replace("_"," ",substr($pdf_file,0,strrpos($pdf_file, '_', -26)));
                                    ?>
                                    </td>
                                    <td>
                                    <?php echo str_replace("_"," ",substr($date_time,0,11));?>
