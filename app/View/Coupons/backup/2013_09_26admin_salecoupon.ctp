...
<script type="text/javascript"> 
	...
	function printDiv(divName) {
	      var  printdata;
		 printdata = '<div style="margin:auto;width:80%;">'; 
	...
	function Popup(data) 
    {
        ...
        /*optional stylesheet*/ //
        // mywindow.document.write('<link rel="stylesheet" type="text/css" href="/css/admin/printcoupon.css" media="all"  />');
        mywindow.document.write('</head><body style="width:100%;height:574px;margin:auto;">');
