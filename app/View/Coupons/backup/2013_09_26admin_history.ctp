...
<script type="text/javascript">
	...
	function SendCouponEmail(row){
		...
		var ShowActivationCode=$("#ShowActivationCode"+row).val(); 
...
<section class="grid_13">
	...
	<div class="no-margin"><table class="table" cellspacing="0" width="100%">
		...
		<th scope="col">
			<span class="sortkey">Product code</span> 
		</th>
		...
		<tr>
			...
			<td> 
				<?php echo $Record['CouponSale']['product_code']; ?>
			</td>
		    ...
		    */ ?>
		    <td> 
				...
				echo $this->Form->input("activation_code",array("type"=>"hidden","id"=>"ShowActivationCode".$i,"value"=>$Record['Coupon']['activation_code']));
				?>
