		...
		<section class="grid_12">
			...
			<div class="block-border">
					<?php echo $this->element('backend/server_error');
						echo $this->Form->create('CmsPage',array('url'=>array('controller'=>'settings','action' => 'add_cms_page', 'admin' =>true),'enctype' => 'multipart/form-data','inputDefaults'=>array('div'=>false,'label'=>false),'id'=>'add_cms_page', 'name' => 'add_cms_page','class' => 'block-content form'));
					?>
						<h1><?php echo ADD_CMS_PAGE; ?></h1>
						<fieldset>
							...
							<p>
								...
								<?php echo $this->Form->input('content',array('type'=>'textarea','row'=>'50','class'=>'full-width text_editor','id'=>'text_editor','style'=>'height:400px;'));?>
							</p>
							<p>
							...
							<p>
								...
								echo $this->Form->submit('Submit',array('div'=>FALSE,'onclick' => 'return ajax_form("add_cms_page","admin/settings/validate_edit_cms_ajax","receiver")','class'=>'submit_button'));
