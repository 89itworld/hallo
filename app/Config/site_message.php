...
define("ERR_ADDRESS_EMPTY","Please enter address.");
define("ERR_CITY_EMPTY","Please enter city name.");
define("ERR_POST_NUMBER_EMPTY","Please enter post number.");
define("ERR_USERNAME_EMPTY","Please enter username.");
define("ERR_USERNAME_ALREADY_EXIST","This username is already exist.");
define("ERR_DELIMITER_EMPTY","Please enter delimiter.");
define("ERR_VALID_DELIMITER","Please enter a valid delimiter");
?>