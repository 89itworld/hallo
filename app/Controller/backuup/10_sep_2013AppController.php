...
class AppController extends Controller {
	...
	/*$pass_slug = !empty($this->params['pass'])?$this->params['pass'][0]:"";
	if(($this->params['controller'] == "homes") && ($this->params['action'] == "index") && ($pass_slug == "1")){
	    $this->redirect(array('controller' => 'homes', 'action' => 'index'));
	}*/
	
	$data_here = trim(str_replace("/hallo","",$this->here));
	if(($data_here == "/homes") || ($data_here == "/homes/") || ($data_here == "/homes/index/1") || ($data_here == "/home")){
	    $this->redirect(array('controller' => 'homes', 'action' => 'index'));
	}
	...
	if($this->params['prefix'] == 'admin'){  
				...
				$this->Auth->userScope = array('User.is_active' => '1','User.is_deleted' => '0');
